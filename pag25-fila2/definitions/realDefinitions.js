...
board2.setArtifact('artifact_1')
board2.createLine(1,[-4,1],[4,1])
...
artifact2.addCurveToMenuCurves('cos', 1, 1, 2, 3)
...
artifact3.evaluateCurveSum('|x|',[0,2])
...
artifact4.evaluateCurveSum('|x|',[0,2])

...
board3.createLine(1,[-5,-2],[5,-2])
const board4 = new Boards ()
board4.createBoard()
board4.boardSize(600,400)
board4.createLine(1,[-5,2],[5,2])
...
board5.createLine(1,[-4,-1],[4,-1])

const board6 = new Boards()
board6.createBoard()                                                                  
board6.boardSize(600, 400)
board6.setArtifact('artifact_6')
board6.createLine(1,[-4,1],[4,1])

const board7 = new Boards()
board7.createBoard()
board7.boardSize(600, 400)
board7.setArtifact('artifact_7')
board7.createLine(1,[-4,2],[4,2])
...
artifact1.addCurveToMenuCurves('sen', 0, -4, -3, -2, -1, 0, 1, 2, 3, 4)
artifact1.addCurveToMenuCurves('cos', 1, 1, 2, 3)
artifact1.addCurveToMenuCurves('(x)', 0, 1, 2, 3)
artifact1.addCurveToMenuCurves('ln', 1 ,0.009, 0.09,0.5,1,2,3.5)
//artifact1.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact1.addCurveToMenuCurves('|x|', 0, -1,-2,-3,0,1, 2, 3)
artifact1.addCurveToMenuCurves('constant')
artifact1.evaluateCurveSum('sen',[0,1])
...
artifact2.addCurveToMenuCurves('cos', 1, -4, -3, -2,-1.57, -1,-0.70,-0.50, 0, 0.50,0.70, 1,1.57, 2, 3, 4)
artifact2.addCurveToMenuCurves('(x)', 0, 1, 2, 3)
artifact2.addCurveToMenuCurves('ln', 1 ,0.009, 0.09,0.5,1,2,3.5)
//artifact2.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact2.addCurveToMenuCurves('|x|', 0, -1,-2,-3,0,1, 2, 3)
artifact2.addCurveToMenuCurves('constant')
artifact2.evaluateCurveSum('cos',[1,1]) //establece
...
artifact3.addCurveToMenuCurves('cos', 1, 1, 2, 3)
artifact3.addCurveToMenuCurves('tg',0, -1.57,-1,-0.5, 0,0.5,1, 1.57)
artifact3.addCurveToMenuCurves('(x)', 0, 1, 2, 3)
artifact3.addCurveToMenuCurves('ln', 1 ,0.009, 0.09,0.5,1,2,3.5)
//artifact3.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact3.addCurveToMenuCurves('|x|', 0, -1,-2,-3,0,1, 2, 3)
artifact3.addCurveToMenuCurves('constant')
artifact3.evaluateCurveSum('tg',[0,-2])
...
artifact4.addCurveToMenuCurves('cos', 1, 1, 2, 3)
artifact4.addCurveToMenuCurves('(x)', 0, 1, 2, 3)
artifact4.addCurveToMenuCurves('ln', 1 ,0.009, 0.09,0.5,1,2,3.5)
artifact4.addCurveToMenuCurves('sqrt', 0 , 0, 1, 1.5, 2, 2.5, 3, 3.5, 4 )
//artifact4.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact4.addCurveToMenuCurves('|x|', 0, -1,-2,-3,0,1, 2, 3)
//artifact4.addCurveToMenuCurves('constant')
artifact4.evaluateCurveSum('sqrt',[0,2])

const artifact5 = new ArtifactCartesian()
  
//artifact1.evaluateCurve('curve1', [1,1],[3,1])
artifact5.showMenuCurves(true)
artifact5.createGridDefault([1, 2], [1, 2])
 
//artifact1.addCurveToMenuCurves('cos', 2, 1,2,3,4,5,6)
//artifact1.addCurveToMenuCurves('sen', null, 1,2,3)
artifact5.addCurveToMenuCurves('sen', 1, -4, -3, -2, -1, 0, 1, 2, 3, 4)
artifact5.addCurveToMenuCurves('cos', 1, 1, 2, 3)                                     
artifact5.addCurveToMenuCurves('(x)', 0, 1, 2, 3)
artifact5.addCurveToMenuCurves('ln', 1 ,0.009, 0.09,0.5,1,2,3.5)
//artifact1.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact5.addCurveToMenuCurves('|x|', 0, -1,-2,-3,0,1, 2, 3)
artifact5.addCurveToMenuCurves('constant')
artifact5.evaluateCurveSum('ln',[1,-1])
//artifact1.evaluateCurveMult(['sen','cos'], false, [[1,1], [2,2]])
//artifact1.evaluateCurveMult(['sen', 'constant'], true, [[1, 1], [2, 2]])
...
artifact6.createGridDefault([1, 2], [1, 2])
artifact6.addCurveToMenuCurves('sen', 1, -4, -3, -2, -1, 0, 1, 2, 3, 4)
artifact6.addCurveToMenuCurves('cos', 1, 1, 2, 3)
artifact6.addCurveToMenuCurves('(x)', 0, 1, 2, 3)
artifact6.addCurveToMenuCurves('ln', 1 ,0.009, 0.09,0.5,1,2,3.5)
//artifact2.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact6.addCurveToMenuCurves('|x|', 0, -1,-2,-3,0,1, 2, 3)
artifact6.addCurveToMenuCurves('constant')
artifact6.evaluateCurveSum('ln',[1,1]) //establece


const artifact7 = new ArtifactCartesian()
artifact7.showMenuCurves(true)
artifact7.createGridDefault([1, 2], [1, 2])
artifact7.addCurveToMenuCurves('sen', 1, -4, -3, -2, -1, 0, 1, 2, 3, 4)               
artifact7.addCurveToMenuCurves('cos', 1, 1, 2, 3)
artifact7.addCurveToMenuCurves('(x)', 0, 1, 2, 3)
artifact7.addCurveToMenuCurves('ln', 1 ,0.009, 0.09,0.5,1,2,3.5)
//artifact3.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact7.addCurveToMenuCurves('|x|', 0, -1,-2,-3,0,1, 2, 3)
artifact7.addCurveToMenuCurves('constant')
artifact7.evaluateCurveSum('|x|',[0,2])


const artifact8 = new ArtifactCartesian()
artifact8.showMenuCurves(true)
artifact8.createGridDefault([1, 2], [1, 2])
artifact8.addCurveToMenuCurves('sen', 1, -4, -3, -2, -1, 0, 1, 2, 3, 4)
artifact8.addCurveToMenuCurves('cos', 1, 1, 2, 3)
artifact8.addCurveToMenuCurves('(x)', 0, 1, 2, 3)                                     
artifact8.addCurveToMenuCurves('ln', 1 ,0.009, 0.09,0.5,1,2,3.5)
//artifact4.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact8.addCurveToMenuCurves('|x|', 0, -1,-2,-3,0,1, 2, 3)
artifact8.addCurveToMenuCurves('constant')
artifact8.evaluateCurveSum('|x|',[0,2])

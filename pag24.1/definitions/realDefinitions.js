...
//artifact1.addCurveToMenuCurves('cos', 2, 1,2,3,4,5,6)
//artifact1.addCurveToMenuCurves('sen', null, 1,2,3)                                  
artifact5.addCurveToMenuCurves('sen', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact5.addCurveToMenuCurves('cos', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact5.addCurveToMenuCurves('(x)', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact5.addCurveToMenuCurves('-(x)', 1, 4, 3, 2, 1, 0, -1, -2, -3, -4)
artifact5.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact5.addCurveToMenuCurves('|x|', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact5.addCurveToMenuCurves('constant')
artifact5.evaluateCurveSum('-(x)',[1,0])
//artifact1.evaluateCurveSum('sen',[1,2])
//artifact1.evaluateCurveMult(['sen','cos'], false, [[1,1], [2,2]])
//artifact1.evaluateCurveMult(['sen', 'constant'], true, [[1, 1], [2, 2]])
...
artifact6.addCurveToMenuCurves('sen', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact6.addCurveToMenuCurves('cos', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact6.addCurveToMenuCurves('(x)', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact6.addCurveToMenuCurves('-(x)', 1, 4, 3, 2, 1, 0, -1, -2, -3, -4)
artifact6.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact6.addCurveToMenuCurves('|x|', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)               
artifact6.addCurveToMenuCurves('constant')
artifact6.evaluateCurveSum('(x)',[1,-1])

const artifact7 = new ArtifactCartesian()
artifact7.showMenuCurves(true)
artifact7.createGridDefault([1, 2], [1, 2])
 
artifact7.addCurveToMenuCurves('sen', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact7.addCurveToMenuCurves('cos', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact7.addCurveToMenuCurves('(x)', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact7.addCurveToMenuCurves('-(x)', 1, 4, 3, 2, 1, 0, -1, -2, -3, -4)
artifact7.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])      
artifact7.addCurveToMenuCurves('|x|', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact7.addCurveToMenuCurves('constant')
artifact7.evaluateCurveSum('(x)',[1,-1])

const artifact8 = new ArtifactCartesian()
artifact8.showMenuCurves(true)
artifact8.createGridDefault([1, 2], [1, 2])
  
artifact8.addCurveToMenuCurves('sen', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact8.addCurveToMenuCurves('cos', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact8.addCurveToMenuCurves('(x)', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact8.addCurveToMenuCurves('-(x)', 1, 4, 3, 2, 1, 0, -1, -2, -3, -4)              
artifact8.addCurveToMenuCurves('1/x', [-1,1], [-1, -2, -3, -0.1],[0.2, 1, 2, 3])
artifact8.addCurveToMenuCurves('|x|', 1, 1, 2, 3, 4, 0, -1, -2, -3, -4)
artifact8.addCurveToMenuCurves('constant')
artifact8.evaluateCurveSum('-(x)',[1,-3])
